...
class UserController extends Controller
{
    ...
    {
        // dd('markAllNotificationComplete');
        ...
        $notifications = Auth::user()->notifications()->get()->map(function ($notification) {
            return [
                ...
                'data' => [
                    ...
                    'interaction' => isset($notification->data['interaction']) ? $notification->data['interaction'] : null,
                    'task' => isset($notification->data['task']) ? $notification->data['task'] : ['task_code' => $notification->data['task_code']],
                ],
    ...
    public function updateSegment(Request $request)
    {
        ...
        $user = auth()->user();
        $user->default_segment = $request->segment;
        $user->save();
