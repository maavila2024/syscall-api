...
class TaskController extends Controller
{
    ...
    public function update(TaskUpdateRequest $request, $id)
    {
        ...
        $comment = sprintf(
            "Complexidade: %s, Justificativa complexidade: %s, Data esperada: %s, Data conclusão: %s, Prioridade: %s, Justificativa prioridade: %s, Sequência: %s, Status: %s, Status do chamado: %s, updated_at: %s",
            $complexityName,
