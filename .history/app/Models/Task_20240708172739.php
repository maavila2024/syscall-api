...
class Task extends Model
{
    ...
    protected $dates = ['expected_date', 'finish_date', 'created_at'];
    ...
    {
        $this->attributes['expected_date'] = $value ? Carbon::parse($value)->format('Y-m-d') : null;
    }

    public function setFinishDateAttribute($value)
    {
        $this->attributes['finish_date'] = $value ? Carbon::parse($value)->format('Y-m-d') : null;
    }
}
