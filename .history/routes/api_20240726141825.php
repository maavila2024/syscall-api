...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('users/notifications/{id}', [UserController::class, 'markNotificationComplete']);
    // Route::get('users/notifications', [UserController::class, 'markAllNotificationComplete']);
    Route::post('users/notifications/mark-all', [UserController::class, 'markAllNotificationComplete'])->middleware('auth:sanctum');
